...
The following section gives an example how to use a private Git repository to version the configuration of an lacolonia-cloud environment. 
...
Assuming that you have created the recommended file structure for your lacolonia-cloud locally you can init a local git repository and add the configuration into the new local repo:
...
With the following example the local git repository, holding the lacolonia-cloud configuration, can be pushed into a private remote repository:
